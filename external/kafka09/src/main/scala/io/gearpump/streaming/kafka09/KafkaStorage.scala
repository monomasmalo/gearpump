...
import io.gearpump.streaming.kafka09.lib.KafkaUtil
import io.gearpump.streaming.kafka09.lib.consumer.KafkaConsumer
 ...
 */
class KafkaStorage private[kafka09](
    topic: String,
  ...
  private[kafka09] def load(consumer: KafkaConsumer): List[(TimeStamp, Array[Byte])] = {
